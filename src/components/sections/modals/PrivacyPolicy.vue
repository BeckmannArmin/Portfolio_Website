<template>
  <div class="privacy-modal">
    <div class="privacy-container">
      <button class="project-close" @click="$emit('closePrivacy')">
      ...
      <div class="privacy-content">
        ...
        <p>Armin Beckmann<br />Elstersteinstraße.28<br />66386 St.Ingbert</p>
        <p>
          E-Mail-Adresse:
          <a href="mailto:hello@arminbeckmann.de">hello@arminbeckmann.de</a>.
        </p>
