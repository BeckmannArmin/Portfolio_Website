<template>
  <div id="shapes">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
      <symbol id="upper" viewBox="0 0 848.48 722.27">
        <path
          d="M847.74,448.1c-6.32-74-52.48-139.72-120.47-171.43-36.46-17-77.78-23.38-119.47-18.44a4.21,4.21,0,0,0-3.44,2.7A218.27,218.27,0,0,1,584,301.24a4.2,4.2,0,0,0,4.54,6.36c42-10.25,83.22-7.16,119.73,9.86C761.69,342.37,798,393.9,802.9,451.93c5.86,68.63-31,134.23-103.75,184.75-2.22,1.47-72.82,47.13-182.89,16.86a4.21,4.21,0,0,0-5.14,2.89L501,691.59a4.2,4.2,0,0,0,2.9,5.21,323.65,323.65,0,0,0,86.52,12.11c81.38,0,131.4-33.19,134.14-35l.17-.12c44.6-30.94,77.86-67.26,98.86-108C842.76,528.51,851.13,487.82,847.74,448.1Z"
        />
      </symbol>
    </svg>

    <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
      <symbol id="upperA" viewBox="0 0 848.48 722.27">
        <path
          d="M1.62,721.48a3.86,3.86,0,0,0,4.73,0L402.61,420.25a4,4,0,0,0,.76-5.53l-22.46-29.54a4,4,0,0,0-5.53-.75L101.27,592.78a3.87,3.87,0,0,1-4.73,0"
        />
      </symbol>
    </svg>
